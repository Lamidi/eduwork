            ...
            <div class="content">
                <div class="row justify-content-center">
                    <div class="card card-info card-outline">
                        <div class="card-body">
                            <form action="<?php echo e(url('simpan_masuk')); ?>" method="post">
                            ...
                            <form action="<?php echo e(url('simpan_keluar')); ?>" method="post">
                                <?php echo e(csrf_field()); ?>
...
</html><?php /**PATH C:\xampp\htdocs\eduwork\absensi\resources\views/presensi/masuk.blade.php ENDPATH**/ ?>